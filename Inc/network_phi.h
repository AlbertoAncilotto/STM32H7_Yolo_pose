...
#ifndef AI_NETWORK_PHI_H
#define AI_NETWORK_PHI_H
#pragma once

#include "network_phi_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_PHI_MODEL_NAME          "network_phi"
#define AI_NETWORK_PHI_ORIGIN_MODEL_NAME   "best_integer_quant"

/******************************************************************************/
#define AI_NETWORK_PHI_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_PHI_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_PHI_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_PHI_IN_NUM        (1)
#define AI_NETWORK_PHI_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 128, 128, 3, 1, NULL), \
}
#define AI_NETWORK_PHI_IN_SIZE { \
  AI_NETWORK_PHI_IN_1_SIZE, \
}
#define AI_NETWORK_PHI_IN_SIZE_BYTES { \
  AI_NETWORK_PHI_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_PHI_IN_1_HEIGHT      (128)
#define AI_NETWORK_PHI_IN_1_WIDTH       (128)
#define AI_NETWORK_PHI_IN_1_CHANNEL     (3)
#define AI_NETWORK_PHI_IN_1_SIZE        (128 * 128 * 3)
#define AI_NETWORK_PHI_IN_1_SIZE_BYTES  (AI_NETWORK_PHI_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_PHI_OUT_NUM       (1)
#define AI_NETWORK_PHI_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 56, 1, 16, 1, NULL), \
}
#define AI_NETWORK_PHI_OUT_SIZE { \
  AI_NETWORK_PHI_OUT_1_SIZE, \
}
#define AI_NETWORK_PHI_OUT_SIZE_BYTES { \
  AI_NETWORK_PHI_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_PHI_OUT_1_HEIGHT      (56)
#define AI_NETWORK_PHI_OUT_1_WIDTH       (1)
#define AI_NETWORK_PHI_OUT_1_CHANNEL     (16)
#define AI_NETWORK_PHI_OUT_1_SIZE        (56 * 1 * 16)
#define AI_NETWORK_PHI_OUT_1_SIZE_BYTES  (AI_NETWORK_PHI_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_NETWORK_PHI_N_NODES (90)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_phi
 ...
 * @ref ai_network_phi_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_phi_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_PHI_*
 * defines into file @ref network_phi.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_phi_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_PHI_H */
